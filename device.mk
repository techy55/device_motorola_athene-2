...
PRODUCT_COPY_FILES +=  \
    ...
    $(LOCAL_PATH)/configs/audio/ap_gain.bin:$(TARGET_COPY_OUT_SYSTEM)/etc/ap_gain.bin \
    $(LOCAL_PATH)/configs/audio/ap_gain_mmul.bin:$(TARGET_COPY_OUT_SYSTEM)/etc/ap_gain_mmul.bin \
    $(LOCAL_PATH)/configs/audio/audio_ext_spkr.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/audio_ext_spkr.conf \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info_extcodec.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/audio_platform_info_extcodec.xml
